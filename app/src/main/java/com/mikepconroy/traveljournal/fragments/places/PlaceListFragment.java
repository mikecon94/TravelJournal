 ...
 * <p/>
 * Activities containing this fragment MUST implement the {@link OnPlaceListInteractionListener}
 * interface.
 */
public class PlaceListFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnPlaceListInteractionListener) {
            mListener = (OnPlaceListInteractionListener) context;
        } else {
